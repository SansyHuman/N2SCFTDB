...
\textbf{Index-package reference: 16 September 2026}
\end{center}
\vspace{3mm}
...
This revision adds disconnected-sector factorization, optional stored-sector
reuse, the single character-cache file argument, and a step-by-step explanation
of degree-bounded FORM multiplication. Earlier cache measurements describe
commit \code{04bbe21} and retain their dates. Property orchestration and GUI
workflows belong to the companion implementation reference. Preserved pages
2--4 present the original mathematical setup and baseline FORM recurrence;

...
\textbf{Index-package reference: 15 September 2026}
\end{center}
\vspace{3mm}
...
measurements. This guide covers the index-package algorithms and their
validation. Property orchestration, MySQL persistence and GUI workflows are
documented in the companion \emph{Mathematical background and implementation
reference}. Mathematical equations are unchanged.

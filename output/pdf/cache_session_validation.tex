...
two live-MySQL tests skipped}. That run used actual Sage/FORM/LiE for backend tests;
its MySQL migration and insertion unit tests used mocks unless a test server
was explicitly configured. Schema migration tests were later removed when
the production layout was reset to schema 1. The new modules are
